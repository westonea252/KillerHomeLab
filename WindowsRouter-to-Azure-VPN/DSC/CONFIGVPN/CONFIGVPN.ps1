    ...
    Node localhost
    {
        ...
        Script ConfigureRRAS
        {
            SetScript =
            {
                ...
                $AddressPrefix = "$using:LocalAddressPrefix"
                ...
                Add-VpnS2SInterface -Protocol IKEv2 -AuthenticationMethod PSKOnly -NumberOfTries 3 -ResponderAuthenticationMethod PSKOnly -Name Azure -Destination "$GatewayIP" -IPv4Subnet @("$AddressPrefix:100") -SharedSecret "$using:SharedKey"
