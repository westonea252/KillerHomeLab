    ...
    Node localhost
    {
        ...
        Script ConfigureADFS
        {
            SetScript =
            {
                ...
                Import-Module ADFS
                Install-AdfsFarm -CertificateThumbprint $thumbprint -FederationServiceName "adfs.$using:RootDomainFQDN" -GroupServiceAccountIdentifier "$using:NetBiosDomain\FsGmsa$" -SQLConnectionString "Data Source=$using:SQLHost;Integrated Security=True"
