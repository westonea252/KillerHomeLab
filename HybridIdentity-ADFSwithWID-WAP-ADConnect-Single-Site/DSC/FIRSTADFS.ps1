    ...
    Node localhost
    {
        ...
        Script ConfigureADFS
        {
            SetScript =
            {
                ...
                Import-Module ADFS
                Install-AdfsFarm -CertificateThumbprint $thumbprint -FederationServiceName "adfs.$using:RootDomainFQDN" -GroupServiceAccountIdentifier "$using:NetBiosDomain\FsGmsa$"
